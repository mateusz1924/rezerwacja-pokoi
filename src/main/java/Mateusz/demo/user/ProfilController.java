...
import Mateusz.demo.utilities.UserUtilities;
import Mateusz.demo.validators.ChangePasswordValidator;
import Mateusz.demo.validators.EditUserProfileValidator;
...
public class ProfilController {
	...
	public String changeUSerPassword(User user, BindingResult result, Model model, Locale locale) { //bindingresult-zraca ewentualne bledy z walidatora, model sluzy do rpzekazywania czegos na strone np po zapisise, , Local - ustawienia jezykowe
